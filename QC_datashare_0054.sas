...
%let input = G:\NIDADSC\DATA_SHARE\CTN0054\Data;
libname in "&input";
...
ods rtf file="G:\NIDADSC\DATA_SHARE\CTN0054\QC\QC_&SYSDATE..rtf";
...
proc contents data=in.BLAB varnum; title 'BLAB'; run;
...
proc contents data=in.ULAB varnum; title 'ULAB'; run;
